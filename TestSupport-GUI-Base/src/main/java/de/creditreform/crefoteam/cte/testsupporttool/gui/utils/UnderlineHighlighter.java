...
/**
 * 1:1-Port aus {@code testsupport_client.tesun.gui.utils.UnderlineHighlighter}.
 *
 * <p>Layered-Highlighter, der markierten Text unterstreicht (statt ihn zu
 * faerben) — fuer Suchergebnis-Markierungen in {@code JTextComponent}s.
 */
