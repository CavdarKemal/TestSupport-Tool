...
/**
 * Schalen-Port. Original prüft die gesammelten Export-XMLs via
 * {@code TestFallCheckCollects} gegen die Kunden-REF-Exports. Im Spike:
...
public class UserTaskCheckCollects extends AbstractUserTaskRunnable {
    ...
    public Map<String, Object> runTask(Map<String, Object> taskVariablesMap) {
        ...
        throw new UnsupportedOperationException(
                "CheckCollects im Real-Mode erfordert TestFallCheckCollects + TestResultsZipHandler (noch nicht portiert).");
    }
}
