...
public final class CteTestAutomatisierung implements TesunClientJobListener {
    ...
    public Map<String, Object> buildTaskVariablesMap(
        ...
        vars.put(UT_TASK_PARAM_NAME_STATE_ENGINE_PROCESS_NAME, environmentConfig.getStateEngineProcessName());
        ...
        vars.put(UT_TASK_PARAM_NAME_EMAIL_FROM, environmentConfig.getStateEngineEmailFrom());
        vars.put(UT_TASK_PARAM_NAME_SUCCESS_EMAIL_TO, environmentConfig.getStateEngineSuccessEmailTo());
        vars.put(UT_TASK_PARAM_NAME_FAILURE_EMAIL_TO, environmentConfig.getStateEngineFailureEmailTo());
