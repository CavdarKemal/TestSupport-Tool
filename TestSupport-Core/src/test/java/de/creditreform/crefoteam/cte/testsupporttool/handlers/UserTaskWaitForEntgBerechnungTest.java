...
/**
 * Unit-Test fuer den frisch portierten {@link UserTaskWaitForEntgBerechnung}.
 ...
 */
class UserTaskWaitForEntgBerechnungTest {

    @Test
    void execute_inDemoMode_returnsNextWithoutRest() throws Exception {
        EnvironmentConfig env = new EnvironmentConfig("ENE");
        UserTaskWaitForEntgBerechnung handler = new UserTaskWaitForEntgBerechnung(env, null);
